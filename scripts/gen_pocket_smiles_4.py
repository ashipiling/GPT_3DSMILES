...
#     # if if_add_more_vertices and len(min_dist_list_set) < 32:
#     #     min_dist_list_set = []
#     #     for dist_list in dist_mat:
#     #         tmp = np.argsort(dist_list)
#     #         if len(tmp) > 0 and not tmp[0] in min_dist_list_set:
...
#     # final_list = min_dist_list_set[:32]
#     final_list = min_dist_list_set
#     ver_list = []
#     for id in final_list:
#         ver_list.append(vertice[id])
    
#     print('ver_list', ver_list)
#     if if_expand and ori_xscore > -7:
#         ver_list = expand_vertices(ver_list, ligand_coords)
#     print('final_vertice_list', len(ver_list))
...
if __name__ == '__main__':
    ...
    out_3dsmiles_path = 'data/pocketsmiles_crossdocked_with_property_15.txt'
