...
def main(pdb_split_path, out_3dsmiles_path, pdb_more_path='', n_worker=32):
    path_dict_list = []
...
if __name__ == '__main__':
    ...
    pdb_more_path = 'data/for_train_gened.pkl'
    out_3dsmiles_path = 'data/pocketsmiles_crossdocked_with_property_17.txt'

    main(pdb_split_path, out_3dsmiles_path, pdb_more_path=pdb_more_path)
