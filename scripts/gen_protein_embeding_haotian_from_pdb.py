...
parser.add_argument('--ckpt', type=str, default='./ckpt/val_172.pt')
parser.add_argument(
...
parser.add_argument(
    '--check_point', type=str, default='./ckpt/val_172.pt',
    help='load the parameter'
)

parser.add_argument(
    '--pdb_file', action='store', required=False, type=str, default=r'D:\code_space\pocket_generate\usecase_protein_embedding\ATK1\4gv1_A_rec.pdb',
    help='protein file specified for generation'
)

parser.add_argument(
    '--sdf_file', action='store', required=False, type=str, default=r'D:\code_space\pocket_generate\usecase_protein_embedding\ATK1\4gv1_ligand.sdf',
...
with torch.no_grad():
    root = f'./usecase_protein_embedding'
    val_list = []
    ...
    with open('usecase_protein_embedding/ATK1/ATK1_protein_represent.pkl', 'ab') as file:
        pickle.dump(protein_input, file)
    # with open('CDK4_mol_groundtruth.pkl', 'ab') as file:
    #     pickle.dump(mols_input, file)
